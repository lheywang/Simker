...
They may be used for testing the container, especially mixed_sim which involve near all of the tools !

They come with Makefile, so don't be afraid to type a Make sim in the folder !
You just need to type make sim, and admire the output !
